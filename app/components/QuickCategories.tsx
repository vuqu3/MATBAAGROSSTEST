...
export default function QuickCategories() {
  const categories = [
    ...
    },
    {
      ...
      name: 'Kartvizit',
      icon: CreditCard,
      link: '/urunler?kategori=kartvizit',
    ...
    },
    {
      ...
      name: 'Karton Çanta',
      icon: ShoppingBag,
      link: '/urunler?kategori=karton-canta',
