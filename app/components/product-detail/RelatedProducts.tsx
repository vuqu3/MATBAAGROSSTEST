...
const MOCK_RELATED_PRODUCTS: RelatedProductCard[] = [
  { id: 'mock-1', name: 'Kuşe Kağıt A4 80gr 500 Yaprak', imageUrl: '/placeholder-product.svg', images: null, basePrice: 89.9, salePrice: null, category: { slug: 'kagit' } },
  { id: 'mock-2', name: 'Mat Kuşe Kartvizit 350gr', imageUrl: '/placeholder-product.svg', images: null, basePrice: 145.5, salePrice: 129.9, category: { slug: 'kartvizit' } },
  { id: 'mock-3', name: 'Selofan Ambalaj 25x35 cm', imageUrl: '/placeholder-product.svg', images: null, basePrice: 249, salePrice: null, category: { slug: 'ambalaj' } },
  { id: 'mock-4', name: 'Etiket Sticker 50x70mm 1000 Adet', imageUrl: '/placeholder-product.svg', images: null, basePrice: 189, salePrice: 169, category: { slug: 'etiket' } },
  { id: 'mock-5', name: 'Bristol Kart 300gr A4', imageUrl: '/placeholder-product.svg', images: null, basePrice: 125, salePrice: null, category: { slug: 'kagit' } },
  { id: 'mock-6', name: 'Folyo Baskılı Broşür 100 Adet', imageUrl: '/placeholder-product.svg', images: null, basePrice: 420, salePrice: 379, category: { slug: 'brosur' } },
  { id: 'mock-7', name: 'Kraft Torba 20x30 cm 100 Adet', imageUrl: '/placeholder-product.svg', images: null, basePrice: 95, salePrice: null, category: { slug: 'ambalaj' } },
  { id: 'mock-8', name: 'PVC Kart 85x54mm 100 Adet', imageUrl: '/placeholder-product.svg', images: null, basePrice: 310, salePrice: 289, category: { slug: 'kartvizit' } },
  { id: 'mock-9', name: 'Zarf C6 114x162mm 100 Adet', imageUrl: '/placeholder-product.svg', images: null, basePrice: 78, salePrice: null, category: { slug: 'zarf' } },
  { id: 'mock-10', name: 'Roll Up Banner 85x200 cm', imageUrl: '/placeholder-product.svg', images: null, basePrice: 599, salePrice: 549, category: { slug: 'banner' } },
  { id: 'mock-11', name: 'Magnet 10x15 cm 100 Adet', imageUrl: '/placeholder-product.svg', images: null, basePrice: 195, salePrice: null, category: { slug: 'magnet' } },
  { id: 'mock-12', name: 'Katalog A4 32 Sayfa Kuşe', imageUrl: '/placeholder-product.svg', images: null, basePrice: 12.5, salePrice: null, category: { slug: 'katalog' } },
];
