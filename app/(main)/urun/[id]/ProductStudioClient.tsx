          ...
          <aside className="w-80 flex-shrink-0 border-l border-slate-200 bg-white overflow-y-auto">
            <div className="p-4 space-y-4">
              ...
              <nav className="text-xs text-slate-500">
                <Link href="/urunler" className="hover:text-brand-orange">Tüm Ürünler</Link>
                <span className="mx-2">/</span>
                <Link href={`/urunler?kategori=${product.category.slug}`} className="hover:text-brand-orange">{product.category.name}</Link>
                <span className="mx-2">/</span>
